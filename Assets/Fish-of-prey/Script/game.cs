...
public class game : MonoBehaviour
{
    ...
    private async void check_hight_score(int new_score)
    {
        ...
        await this.carrot.game.update_scores_playerAsync(this.game_scores_hight);
    ...
    public async void Test_upload_socers()
    {
        await this.carrot.game.update_scores_playerAsync(Random.Range(2, 12),0);
    }
